...
export const Repo = ({ name, link }: RepoProps) => {
  return (
    ...
    <a
      href={link}
      className="flex border dark:border-slate-700 text-black dark:text-white bg-white w-full p-5 rounded-xl space-x-4 items-center hover:bg-blue-500 dark:hover:bg-blue-500"
      target="_blank"
    >
      <svg
        width="30"
