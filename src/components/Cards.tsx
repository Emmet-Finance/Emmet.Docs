...
const cards = [
  {
    description: "The gateway for understanding Emmet.Finance technological stack.",
  ...
  {
    description: "Outline of features and architecture of Emmet.Finance",
    title: "Whitepaper",
    color: "#FB8417",
    image: (
      <svg
    ...
    link: "https://github.com/Emmet-Finance/whitepaper/blob/main/Emmet_Finance_Whitepaper.pdf",
  },
  {
    description:
      "Bootstraps for rapid Emmet dApp integration",
...
export const Cards = () => {
  return (
    <>
      <div className="flex p-6 pt-5 gap-6 flex-col md:flex-row">
        {cards.map((c, i) => {
          return <Card {...c} key={i} />;
        })}
      </div>
